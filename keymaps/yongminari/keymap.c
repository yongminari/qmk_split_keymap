...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NAV] = LAYOUT_split_3x6_3_ex2(
        /* Row 0: Left & Right */
        _______, KC_ESC,  MS_WH_L, MS_WH_D, MS_WH_U, MS_WH_R, TG(_RAW),  TG(_RAW), KC_HOME, KC_PGUP, KC_PGDN, KC_END,  _______, _______,
        /* Row 1: Left & Right */
    ...
    [_NUM] = LAYOUT_split_3x6_3_ex2(
        /* Row 0: Left & Right */
        KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_LCBR,   _______, KC_SLSH, KC_7,    KC_8,    KC_9,    KC_MINS, KC_TILD,
        /* Row 1: Left & Right */
